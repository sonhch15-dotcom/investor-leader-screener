...
def make_account(key):
	return {
		...
		"first_buy_date": None, "selected": [],
	}
class LongHorizonLeaderAudit(QCAlgorithm):
	def initialize(self):
	...
	def on_end_of_algorithm(self):
		...
		self.debug(
			f"LONG_META|mode=PIT|class={CLASSIFICATION_MODE}|signals={self.cohort_index}|"
